...
## Environments
- Preview: https://main--swetabar-250806--aemysites.aem.page/
- Live: https://main--swetabar-250806--aemysites.aem.live/
...
1. Open the `swetabar-250806` directory in your favorite IDE and start coding :)
